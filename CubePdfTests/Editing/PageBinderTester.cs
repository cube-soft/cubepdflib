...
namespace CubePdfTests.Editing
{
    ...
    public class PageBinderTester
    {
        ...
        [TestCase("readme.pdf",     "annotation.pdf",  "TestMergeAnnot1Smart.pdf",  true)]
        [TestCase("annotation.pdf", "readme.pdf",      "TestMergeAnnotation2.pdf", false)]
        [TestCase("annotation.pdf", "readme.pdf",      "TestMergeAnnot2Smart.pdf",  true)]
        [TestCase("annotation2.pdf", "annotation.pdf", "TestMergeAnnotation3.pdf", false)]
        [TestCase("annotation2.pdf", "annotation.pdf", "TestMergeAnnot3Smart.pdf",  true)]
        [TestCase("annotation.pdf", "annotation2.pdf", "TestMergeAnnotation4.pdf", false)]
        [TestCase("annotation.pdf", "annotation2.pdf", "TestMergeAnnot4Smart.pdf", true)]
